...
- 使用Date实例的方法和属性<br />![](images%5C%E5%9B%BE%E7%89%871.png#alt=)
- 通过Date实例获取总毫米数
...
- 数组中有进行增加、删除元素的方法，部分方法如下表<br />![](images%5C%E5%9B%BE%E7%89%872.png#alt=)<br />注意：push、unshift为增加元素方法；pop、shift为删除元素的方法
...
- 数组中有对数组本身排序的方法，部分方法如下表<br />![](images%5C%E5%9B%BE%E7%89%873.png#alt=)<br />注意：sort方法需要传入参数来设置升序、降序排序
...
- 数组中有获取数组指定元素索引值的方法，部分方法如下表<br />![](images%5C%E5%9B%BE%E7%89%874.png#alt=)
...
- 数组中有把数组转化为字符串的方法，部分方法如下表<br />![](images%5C%E5%9B%BE%E7%89%875.png#alt=)<br />注意：join方法如果不传入参数，则按照 “ , ”拼接元素
...
- 数组中还有其他操作方法，同学们可以在课下自行查阅学习<br />![](images%5C%E5%9B%BE%E7%89%876.png#alt=)
...
<br />![](images%5C%E5%9B%BE%E7%89%877.png#alt=)<br />
...
<br />![](images%5C%E5%9B%BE%E7%89%878.png#alt=)<br />
...
<br />![](images%5C%E5%9B%BE%E7%89%8712.png#alt=)<br />

- 复杂数据类型的存储方式<br />		引用类型变量（栈空间）里存放的是地址，真正的对象实例存放在堆空间中<br />![](images%5C%E5%9B%BE%E7%89%8713.png#alt=)
...
<br />		运行结果如下：<br />
<br />![](images%5C%E5%9B%BE%E7%89%8714.png#alt=)<br />
...
<br />		运行结果如下：<br />
<br />![](images%5C%E5%9B%BE%E7%89%8715.png#alt=)
