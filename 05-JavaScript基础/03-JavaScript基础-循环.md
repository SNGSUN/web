...
<br />for(初始化变量; 条件表达式; 操作表达式 ){<br />//循环体<br />}<br />
...
- for 循环重复不相同的代码<br />例如，求输出1到100岁：


<br />//  基本写法<br />for (var i = 1; i <= 100; i++) {<br />console.log('这个人今年' + i + '岁了');<br />}<br />
...
<br />运行结果：<br />
<br />![](images%5C%E5%9B%BE%E7%89%872.png#alt=)<br />
...
<br />![](images%5C%E5%9B%BE%E7%89%873.png#alt=)
